// 定义brandController
angular.module("adInfo").controller("adInfoEditController", function ($scope, adInfoService,adTypeService, $controller,$routeParams) {
    ...
    $scope.queryType = function () {
        adTypeService.get().then(function (res) {
    ...
    $scope.queryById = function (id) {
        adInfoService.get(id).then(function (res) {
